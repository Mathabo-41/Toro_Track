...
// Remove unused imports if they are not needed elsewhere
...
const LazyAdminOverviewContent = lazy(() => import('./ClientProfContent'));

export default function AdminOverviewPage() {
  return (
    // Use the LoadingScreen component in the fallback prop
    <Suspense fallback={<LoadingScreen message="Loading Client Profile..." />}>
