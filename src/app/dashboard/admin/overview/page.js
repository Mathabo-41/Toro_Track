...
// 1. Import your new LoadingScreen component
import LoadingScreen from '../common/LoadingScreen';

const LazyAdminOverviewContent = lazy(() => import('./AdminOverviewContent'));

export default function AdminOverviewPage() {
  return (
    // 2. Use the LoadingScreen component in the fallback prop
